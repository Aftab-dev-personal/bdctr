...
import CarouselComponent from "./sections/CarouselComponent";
...
function App() {
  ...
  return (
    <section className="w-full h-auto flex justify-center items-center bg-gradient-to-b from-[#3ED484] from-30% to-[#083051] to-70% text-white overflow-hidden">
